#!/bin/bash
# ============================================
# TrendRadar 数据库初始化脚本 (Linux/Mac)
# ============================================

echo "============================================"
echo " TrendRadar 数据库初始化"
echo "============================================"
echo ""
...
# 执行 SQL 脚本
PGPASSWORD=lemon2judy psql -h 103.36.221.226 -U postgres -d postgres -f scripts/init_schema.sql
